...
class Plant(Base):
    ...
    specific_position: Mapped[str | None] = mapped_column(String(160), nullable=True)
    ...
    drying_status: Mapped[str | None] = mapped_column(String(32), nullable=True)
    drying_note: Mapped[str | None] = mapped_column(String(600), nullable=True)
    wet_duration_hours_override: Mapped[float | None] = mapped_column(Float, nullable=True)
